...
let products = [
    {
        name: 'Cặp hươu cao cổ đồng xưa',
        tag: 'menu_1',
        price: 100,
        inCart: 0
    },
    {
        name: 'Khay đĩa gốm sứ trung quốc',
        tag: 'menu_ 2',
        price: 550,
        inCart: 0
    },
    ...
    {
        name: 'KHAY TRÀ CẨN ỐC XÀ CỪ GỖ TRẮC',
        tag: 'menu_4',
        price: 3000,
        inCart: 0
    },
    {
        name: 'Xe Đạp Velosolex 2200 sx 1962 zin',
        tag: 'menu_5',
        price: 59000,
        inCart: 0
    },
    ...
    if ( cartItems && productContainer ) {
        ...
        productContainer.innerHTML += `
            <div class="total-cost">
                ...
                <h4 class="total-cost-price"> ${cartCost}.000đ </h4> 
            </div>
        `;  
    }
